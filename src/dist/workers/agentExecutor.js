...
// workers/agentExecutor.ts
var agentExecutor_exports = {};
__export(agentExecutor_exports, {
  agentExecutorRequestSchema: () => agentExecutorRequestSchema,
  agentExecutorResponseSchema: () => agentExecutorResponseSchema
});
module.exports = __toCommonJS(agentExecutor_exports);

// ../node_modules/.pnpm/zod@3.25.61/node_modules/zod/dist/esm/v3/external.js
...
// ../node_modules/.pnpm/zod@3.25.61/node_modules/zod/dist/esm/v3/helpers/util.js
var util;
(function(util2) {
  util2.assertEqual = (_) => {
  };
...
// ../node_modules/.pnpm/zod@3.25.61/node_modules/zod/dist/esm/v3/ZodError.js
...
// ../node_modules/.pnpm/zod@3.25.61/node_modules/zod/dist/esm/v3/locales/en.js
...
// ../node_modules/.pnpm/zod@3.25.61/node_modules/zod/dist/esm/v3/errors.js
...
// ../node_modules/.pnpm/zod@3.25.61/node_modules/zod/dist/esm/v3/helpers/parseUtil.js
...
// ../node_modules/.pnpm/zod@3.25.61/node_modules/zod/dist/esm/v3/helpers/errorUtil.js
var errorUtil;
(function(errorUtil2) {
...
// ../node_modules/.pnpm/zod@3.25.61/node_modules/zod/dist/esm/v3/types.js
...
var agentExecutorResponseSchema = external_exports.discriminatedUnion("success", [
  external_exports.object({
    ...
    toolsUsed: external_exports.array(external_exports.string()).optional()
  }),
  external_exports.object({
...
var StandaloneTaskExecutor = class {
  workspacePath;
  usedTools = [];
  constructor(workspacePath) {
    this.workspacePath = workspacePath || process.cwd();
  }
  async executeTask(agent, userMessage, apiConfig) {
...
\u8BF7\u57FA\u4E8E\u5DE5\u5177\u6267\u884C\u7ED3\u679C\uFF0C\u7ED9\u51FA\u6700\u7EC8\u7684\u5B8C\u6574\u56DE\u590D:`;
  ...
  async callAI(message, agent, apiConfig) {
    try {
      const availableTools = agent.tools.filter((t) => t.enabled).map((t) => t.toolId);
...
4. \u50CF\u4E00\u4E2A\u771F\u6B63\u7684AI\u52A9\u624B\uFF0C\u800C\u4E0D\u662F\u7B49\u5F85\u6307\u4EE4\u7684\u5DE5\u5177`;
      const response = await fetch(`${apiConfig.openAiBaseUrl}/chat/completions`, {
        ...
        body: JSON.stringify({
          ...
          max_tokens: apiConfig.maxTokens || 2e3,
...
var AgentExecutorWorker = class {
  ...
  async getApiConfigForAgent(apiConfigId) {
